#!/bin/sh
#
#SBATCH --job-name=admixture.mac2               # Job Name
#SBATCH --nodes=1             # 40 nodes
#SBATCH --ntasks-per-node=5               # 40 CPU allocation per Task
#SBATCH --partition=sixhour            # Name of the Slurm partition used
#SBATCH --chdir=/home/d669d153/work/towhees/admixture.mac2     # Set working d$
...
/home/d669d153/work/plink --vcf /home/d669d153/work/towhees/admixture.mac2/towhee.mac2.vcf --double-id --allow-extra-chr --make-bed --out binary_fileset
